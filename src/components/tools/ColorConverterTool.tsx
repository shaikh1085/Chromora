...
export const ColorConverterTool: React.FC<{
  ...
  return (
    <div className="min-h-screen py-8">
      <SEO
        config={{
          title: `${pageTitle} — Chromora`,
          description:
            'Free multi-space color converter for HEX, RGB, HSL, HSV, CMYK, and OKLCH with zero server latency.',
          ...
          softwareApp: {
            ...
            description: 'Multi-space color converter utility.',
