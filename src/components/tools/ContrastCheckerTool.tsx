...
export const ContrastCheckerTool: React.FC<{ navigate: (route: string) => void }> = ({
  ...
  return (
    <div className="min-h-screen py-8">
      <SEO
        config={{
          title: 'WCAG Color Contrast Checker & Generator — Chromora',
          description:
            'Free WCAG contrast checker and generator. Test color palette contrast ratios, simulate color blindness, and generate accessible text color combinations.',
          canonicalUrl: 'https://chromora.app/contrast-checker',
          faqs: contrastFaqs,
          softwareApp: {
            name: 'Chromora Contrast Checker',
            description: 'WCAG color contrast checker and accessible palette generator.',
