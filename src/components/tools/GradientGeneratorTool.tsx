...
export const GradientGeneratorTool: React.FC<{ navigate: (route: string) => void }> = ({
  ...
  return (
    <div className="min-h-screen py-8">
      <SEO
        config={{
          title: 'Online CSS Gradient Generator & Studio — Chromora',
          description:
            'Create custom linear and radial backgrounds with our CSS gradient generator. Blend CSS color codes, adjust angles, and export production CSS code instantly.',
          canonicalUrl: 'https://chromora.app/gradient-generator',
          faqs: gradientFaqs,
          softwareApp: {
            name: 'Chromora CSS Gradient Generator',
            description: 'Online CSS gradient designer and visual editor.',
