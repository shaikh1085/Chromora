...
export const AIPromptGeneratorTool: React.FC<{ navigate: (route: string) => void }> = ({
  ...
  return (
    <div className="min-h-screen py-8">
      <SEO
        config={{
          title: 'AI Color Palette Generator from Text Prompts — Chromora',
          description:
            'Free AI color palette generator from text prompts. Create harmonious color schemes for websites and apps with instant WCAG contrast and live preview.',
          canonicalUrl: 'https://chromora.app/ai-palette-generator',
          faqs: promptFaqs,
          softwareApp: {
            name: 'Chromora AI Palette Generator',
            description: 'Free AI color palette generator from text prompts for websites and apps.',
