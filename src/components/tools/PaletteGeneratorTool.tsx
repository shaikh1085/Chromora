      ...
      <SEO
        config={{
          ...
          keywords: [
            ...
            'color scheme creator with contrast check',
            'tailwind color palette generator',
            'analogous and complementary color palette generator',
          ...
          softwareApp: {
            ...
            description: 'Free accessible color palette generator with 12 harmony modes, live UI preview, and design tokens export.',
