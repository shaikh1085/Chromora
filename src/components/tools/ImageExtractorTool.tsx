...
export const ImageExtractorTool: React.FC<{ navigate: (route: string) => void }> = ({
  ...
  return (
    <div className="min-h-screen py-8">
      <SEO
        config={{
          title: 'Image to Color Palette Extractor — Chromora',
          description:
            'Upload any photo to extract dominant color palettes and sample pixels with a live eyedropper tool. 100% private, client-side browser processing.',
          canonicalUrl: 'https://chromora.app/image-color-palette',
          faqs: extractorFaqs,
          softwareApp: {
            name: 'Chromora Image Color Extractor',
            description: 'Client-side dominant color extractor from photos.',
