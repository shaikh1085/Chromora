      ...
      <SEO
        config={{
          ...
          keywords: [
            ...
            'complementary color wheel finder',
            'triadic color scheme creator',
          ...
          softwareApp: {
            ...
            description: 'Interactive color wheel for discovering complementary, analogous, triadic, and geometric harmonies.',
