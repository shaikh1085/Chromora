...
export const QuickSearchModal: React.FC<QuickSearchModalProps> = ({
  ...
  const tools = [
    ...
    { title: 'AI Color Palette Generator', route: '/ai-palette-generator', icon: Palette, category: 'Tool' },
    { title: 'Image to Color Palette Extractor', route: '/image-color-extractor', icon: ImageIcon, category: 'Tool' },
    { title: 'WCAG 2.1 Contrast Checker', route: '/wcag-contrast-checker', icon: CheckCircle, category: 'Tool' },
    ...
    { title: 'Color Shades & Tints Generator (Tailwind)', route: '/color-shades-generator', icon: Layers, category: 'Tool' },
    { title: 'Color Mixer Online (OKLCH & RGB)', route: '/color-mixer', icon: Repeat, category: 'Tool' },
    { title: 'Color Blindness Simulator (8 Types)', route: '/color-blindness-simulator', icon: CheckCircle, category: 'Tool' },
    { title: 'Random Color & Palette Generator', route: '/random-color-generator', icon: Palette, category: 'Tool' },
    { title: 'Pantone & RAL Converter', route: '/pantone-color-converter', icon: Repeat, category: 'Tool' },
    { title: 'Favicon & App Icon Generator', route: '/favicon-generator', icon: Compass, category: 'Tool' },
    { title: 'Live UI Design Preview Studio', route: '/design-preview', icon: Layers, category: 'Tool' },
    { title: 'HEX to RGB Converter', route: '/hex-to-rgb', icon: Repeat, category: 'Converter' },
    { title: 'RGB to HEX Converter', route: '/rgb-to-hex', icon: Repeat, category: 'Converter' },
    { title: 'HEX to OKLCH Converter', route: '/hex-to-oklch', icon: Repeat, category: 'Converter' },
    { title: 'Color Tools Hub', route: '/color-tools', icon: Compass, category: 'Hub' },
    { title: 'Palette Tools Hub', route: '/palette-tools', icon: Palette, category: 'Hub' },
    { title: 'Accessibility Tools Hub', route: '/accessibility-tools', icon: CheckCircle, category: 'Hub' },
    { title: 'Developer Color Tools Hub', route: '/developer-color-tools', icon: Layers, category: 'Hub' },
    { title: 'Image Color Tools Hub', route: '/image-color-tools', icon: ImageIcon, category: 'Hub' },
    { title: 'Palette Collections Directory', route: '/palettes', icon: FolderHeart, category: 'Collection' },
    { title: 'Color Guides & Theory Articles', route: '/guides', icon: BookOpen, category: 'Guide' },
    { title: 'HEX vs RGB vs HSL Guide', route: '/guides/hex-vs-rgb-vs-hsl', icon: BookOpen, category: 'Guide' },
    { title: 'Color Theory for UI Designers', route: '/guides/color-theory-for-designers', icon: BookOpen, category: 'Guide' },
    { title: 'WCAG Accessible Color Palettes Guide', route: '/guides/accessible-color-palettes-wcag', icon: BookOpen, category: 'Guide' },
    { title: 'Modern OKLCH Color Space Guide', route: '/guides/oklch-color-space-guide', icon: BookOpen, category: 'Guide' },
