...
export const HomePage: React.FC<{ navigate: (route: string) => void }> = ({ navigate }) => {
  ...
  const homeFaqs = [
    {
      question: 'What is Chromora and why was it built?',
      answer:
        'Chromora is a unified color intelligence platform created for digital product designers, front-end engineers, and brand strategists. It replaces disjointed hex lookup websites with mathematically accurate conversions, WCAG 2.1 compliance auditing, Tailwind shade curves, and production-ready design tokens.',
    },
    {
      question: 'Does Chromora send any of my data or uploaded photos to external servers?',
      answer:
        'No. Chromora operates entirely on client-side algorithms within your browser. All image processing, color extraction, and palette generation runs locally on your machine with zero server tracking and maximum privacy.',
    },
    {
      question: 'Can I export color systems to Tailwind CSS and Figma?',
      answer:
        'Yes! Chromora features a Developer Export Center that formats any color palette into Tailwind CSS color objects, W3C JSON design tokens, CSS custom properties (:root), SCSS variables, or SVG swatch files.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-transparent text-[var(--text-primary)]">
      <SEO
        config={{
          title: 'Chromora — Turn Any Color Into a Complete Design System',
          description:
            'Explore hex color codes, create 12-harmony palettes, extract colors from images, and test WCAG 2.1 accessibility contrast for modern digital design systems.',
          canonicalUrl: 'https://chromora.app',
          faqs: homeFaqs,
          softwareApp: {
            name: 'Chromora Color Platform',
            description: 'Intelligent color platform for designers and developers.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-4xl mx-auto mb-10 lg:mb-14 space-y-4">
            ...
            <p className="text-[var(--text-secondary)] text-base sm:text-lg max-w-2xl mx-auto leading-relaxed text-center">
              Chromora empowers designers to discover accessible palettes, preview live designs, and generate design tokens.
            </p>
          </div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold text-[var(--text-primary)] tracking-tight">
            Comprehensive Color Engineering Suite
          </h2>
          <p className="mt-2 text-sm text-[var(--text-secondary)]">
            Precision mathematical tools crafted for high-performance workflows without paid API keys.
          </p>
        </div>
      ...
      <FAQSection
        faqs={homeFaqs}
        title="Chromora Color Platform FAQ"
        subtitle="Answers to common questions about color science, export formats, and zero-server privacy."
      />
    </div>
  );
};
